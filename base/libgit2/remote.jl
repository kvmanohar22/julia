...
The keyword arguments are:
  * `options`: an optional argument determining the options for the fetch,
     e.g. whether to prune afterwards.
  * `msg`: an optional argument to insert into the reflogs.
"""
...
The keyword arguments are:
  ...
  * `options`: an optional argument determining the options for the push,
     e.g. which proxy headers to use.
"""
